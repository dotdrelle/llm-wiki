...
.runtime-graph-shell{height:100%;min-height:100%;display:grid;grid-template-columns:minmax(0,1fr) 180px;gap:8px}
...
@media (max-width: 980px){.runtime-graph-shell{grid-template-columns:1fr;height:auto}.runtime-graph-svg{height:420px}}
