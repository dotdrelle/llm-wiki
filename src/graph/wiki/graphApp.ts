...
/* Le graph n'utilise pas les memes noms de variables que le chat : on mappe
   --border et --panel-soft sur ses equivalents pour que le modal partage
   exactement le meme rendu. */
.confirm-modal{--border:var(--line,#34485e);--panel-soft:var(--soft,#0d1825)}
...
#document-preview-title{text-transform:uppercase}.inspector{position:relative}.inspector-collapsed #inspector{display:none!important}.inspector-collapsed .inspector-title::after{content:'+'}.stage:fullscreen{width:100vw;height:100vh;border:0;border-radius:0;background:#08111d}.stage:fullscreen #canvas{min-height:0}
...
.theme-toggle{flex:none;width:38px;height:34px;padding:0;font-size:17px}.theme-light{color-scheme:light;--bg:#eef3f8;--panel:#fff;--soft:#e8eef5;--line:#b8c6d5;--text:#172433;--muted:#5f7082;--accent:#176b87}.theme-light body{background:#ffffff;color:var(--text)}body.theme-light{background:#ffffff;color:var(--text)}body.theme-light header{background:#f8fbfddd;border-color:#b8c6d5}body.theme-light .brand{color:#172433}body.theme-light .filters,body.theme-light .inspector,body.theme-light .stage{background:#ffffffeb}body.theme-light button,body.theme-light input{color:#172433;background:#edf3f8;border-color:#b8c6d5}body.theme-light button:hover,body.theme-light button.active{background:#cfe3fb;border-color:#5d91cc}body.theme-light .graph-search-results,body.theme-light .document-preview-overlay{background:#fff;color:#172433}body.theme-light .map-label,body.theme-light .map-count,body.theme-light .map-community-link text,body.theme-light .node text{fill:#172433;stroke:#f7fafc}body.theme-light .focus-title{fill:#172433}body.theme-light .focus-card rect{fill:#f5f8fb;stroke:#8fa3b8}body.theme-light .focus-card.member rect{fill:#eadcff;stroke:#8354bf}body.theme-light .community-relation-legend,body.theme-light .focus-caption-overlay,body.theme-light .focus-name-index,body.theme-light .relation-legend{background:#fffffff0;color:#40556a}
...
body.theme-light .community-actions button{background:#ffffffc4;border-color:#00000024;color:#40556a}
...
.agent-btn{background:var(--accent)!important;border-color:var(--accent)!important;color:#08111d!important;font-weight:700;display:inline-flex;align-items:center;gap:5px}
.agent-btn:hover{background:color-mix(in srgb,var(--accent) 82%,black)!important;border-color:color-mix(in srgb,var(--accent) 82%,black)!important}
body.theme-light .agent-btn{color:#fff!important}
body.theme-light .agent-btn:hover{background:color-mix(in srgb,var(--accent) 82%,black)!important;border-color:color-mix(in srgb,var(--accent) 82%,black)!important}
